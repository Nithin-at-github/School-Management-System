 ...
 if((isset($_SESSION['id'])) && (isset($_SESSION['name']))){
   ...
   $sql=mysqli_query($con,"SELECT * FROM `sms_s-notification` WHERE `active`='1' AND `receiver`='".$_SESSION['name']."'");
    ...
    if(isset($_POST['conduct'])){
        ...
        $teach=mysqli_query($con,"select tid from sms_teachers where t_fullname='".$_SESSION['name']."'");
        $r=mysqli_fetch_assoc($teach);
        mysqli_query($con,"INSERT INTO `sms_class`(`tid`, `class`, `sec`, `date`, `time`, `link`) VALUES ('".$r['tid']."','".$class."','".$sec."','".date("Y/d/m")."','".date("h:i:sa")."','".$link."')");

        $stud=mysqli_query($con,"select s_fullname from sms_students where s_class='".$class."' and s_sec='".$sec."'");
        while($f=mysqli_fetch_assoc($stud)){
            mysqli_query($con,"INSERT INTO `sms_s-notification`(`notifications_name`, `message`, `active`, `receiver`) VALUES ('Class','".$_SESSION['name']." hosted a class. Please join now.','1','".$f['s_fullname']."')");
        }
        ?>
            <script>
              alert("Class recorded and Link distributed Successfully.");
            </script>
        <?php
    }
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-2" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="#">Conduct Class</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
            ...
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Conduct Class</h2>
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="index.html" class="breadcrumb-link">Class</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Conduct Class</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <form method="post" action="#">
                        ...
                        <a href="https://meet.google.com/" target="_blank" rel="noopener noreferrer">Generate Link</a>
                        <br><br>
                        <div class="form-group row">
                            <label class="control-label col-md-1">Class Link</label>
                            <div class="col-md-6">
                                <input type="text" name="link" class="form-control">
                            </div>
                        </div>
                        <br><br>
                        <button type="submit" name="conduct">Conduct</button>
                    </form>
                </div>
            </div>
