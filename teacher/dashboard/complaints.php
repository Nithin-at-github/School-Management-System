                    ...
                    <div class="tab-pane fade active show" id="inbox" aria-labelledby="inbox-tab" role="tabpanel">
                        <div>
                            <div class="row p-4 no-gutters align-items-center">
                                <?php
                                  $act=mysqli_query($con,"select * from sms_complaints where receiver='".$_SESSION['name']."' AND active='1'");
                            ...
                            <?php
                                if(isset($_POST['show'])){
                                    $show=mysqli_query($con,"select * from sms_complaints where receiver='".$_SESSION['name']."' order by id desc");
                            ...
                            <div class="table-responsive">
                                <table class="table email-table no-wrap table-hover v-middle mb-0 font-14">
                                    <tbody>
                                        ...
                                        <!-- row -->
                                        <?php
                                          $det=mysqli_query($con,"select * from sms_complaints where receiver='".$_SESSION['name']."' AND active='1' order by id desc");
                                          $i="1";
