<?php
 ...
 if((isset($_SESSION['id'])) && (isset($_SESSION['name']))){
    ...
    $sql1 = "SELECT COUNT(*) as total1 FROM sms_students";
    $sql2 = "SELECT COUNT(*) as total2 FROM sms_teachers";
    $sql3 = "SELECT COUNT(*) as total3 FROM sms_parents"; 
    $result1 = $con->query($sql1);
    $result2 = $con->query($sql2);
    $result3 = $con->query($sql3);

    $sql=mysqli_query($con,"SELECT * FROM `sms_t-notification` WHERE `active`='1' AND `receiver`='".$_SESSION['name']."'");
    $count=mysqli_num_rows($sql);

    if(isset($_POST['submit'])){
        $qry="UPDATE `sms_t-notification` SET `active`='0' WHERE `active`='1' AND `receiver`='".$_SESSION['name']."'";
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Teacher Dashboard</h2>
                    ...
                    <div class="ecommerce-widget">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-muted">Parents</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1">
                                                <?php 
