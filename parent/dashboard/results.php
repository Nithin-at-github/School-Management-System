            ...
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    if(isset($_POST['show'])){
                       ...
                       $p=mysqli_query($con,"select pid from sms_parents where p_name='".$_SESSION['name']."'");
                       $pd=mysqli_fetch_assoc($p);

                       $s=mysqli_query($con,"select * from sms_students where parent_id='".$pd['pid']."'");
                       ...
                       if(mysqli_num_rows($cod)>0){
                            ...
                            <div class="card" style="width: 70%; font-weight: bolder;">
                                 <table cellpadding="10"  cellspacing="6">
                                    ...
                                    <tr style="height: 70px;">
                                        <td>Name : <?php echo $sd['s_fullname']; ?></td>
