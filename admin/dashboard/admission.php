                ...
                <div class="container-fluid dashboard-content ">
                            ...
                            <div class="page-header">
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="index.html" class="breadcrumb-link">Students</a></li>
                    ...
                    <?php
                      if(isset($_POST["submit"])){
                        $id=$_POST['id'];
                        $qry=mysqli_query($con,"select * from sms_admission where id='".$id."'");
                        $qry1=mysqli_query($con,"select pid from sms_parents where pid=(SELECT MAX(pid) from sms_parents)");
                        if(mysqli_num_rows($qry)>0){
                            while ($r=mysqli_fetch_array($qry)) {
                                ...
                                <table cellpadding="16" width="60%" cellspacing="10">
                                    ...
                                    <tr>
                                        <td>Full Name</td>
                                        <td><input type=text name="name" value="<?php echo $r["g_name"]; ?>" size="45" required=></td>
                            
                                        <td>Phone No.</td>
                                        <td><input type="text" name="phoneno" value="<?php echo $r["g_phone no"]; ?>" size="45" required></td>
                                    </tr>
                                    <tr>
                                        <td>Email</td>
                                        <td><input type="email" name="email" value="<?php echo $r["g_email"]; ?>" size="45" required></td>
                            
                                        <td>House Name</td>
                                        <td><input type="text" name="housename" value="<?php echo $r["g_house name"]; ?>" size="45" required></td>
                                    </tr>
                                    <tr>
                                        <td>Street Name</td>
                                        <td><input type="text" name="streetname" value="<?php echo $r["g_street name"]; ?>" size="45" required></td>

                                        <td>City</td>
                                        <td><input type="text" name="city" value="<?php echo $r["g_city"]; ?>" size="45" required></td>
                                    </tr>
                                    <tr>
                                        <td>Pincode</td>
                                        <td><input type="text" name="pincode" value="<?php echo $r["g_pincode"]; ?>" size="45" required></td>

                                        <td>Fee id</td>
                                        <td><input type="text" name="feeid" size="20" required></td>
                                    </tr>
                                    <br>
                                    <tr>
                                    <td colspan=6>
                                        <center><font size=4><b>Student Registration</b></font></center>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Full Name</td>
                                    <td><input type=text name="sname" value="<?php echo $r["s_name"]; ?>" size="45" required=></td>
                            
                                    <td>House Name</td>
                                    <td><input type="text" name="s_housename" value="<?php echo $r["house name"]; ?>" size="45" required></td>
                                </tr>
                                <tr>
                                    <td>Street Name</td>
                                    <td><input type="text" name="s_streetname" value="<?php echo $r["street name"]; ?>" size="45" required></td>
                            
                                    <td>City</td>
                                    <td><input type="text" name="s_city" value="<?php echo $r["city"]; ?>" size="45" required></td>
                                </tr>
                                <tr>
                                    <td>Pincode</td>
                                    <td><input type="text" name="s_pincode" value="<?php echo $r["pincode"]; ?>" size="45" required></td>

                                    <td>Email</td>
                                    <td><input type="email" name="s_email" value="<?php echo $r["email"]; ?>" size="45" required></td>
                                </tr>
                                <tr>
                                    <td>D.O.B</td>
                                    <td><input type="date" name="s_dob" value="<?php echo $r["dob"]; ?>" size="45" required></td>

                                    <td>Gender</td>
                                    <td><input type=text name="s_gender" value="<?php echo $r["sex"]; ?>" size="20" required=></td>
                                </tr>
                                <tr>
                                    <td>Class</td>
                                    <td><input type="text" name="class" value="<?php echo $r["class"]; ?>" size="20" required></td>
                                ...
                                <tr>
                                    <td>D.O.J</td>
                                    <td><input type="date" name="doj" size="45" required></td>
                                    ...
                                    ?>
                                    <td><input type="text" name="pid" value="<?php echo $r1["pid"]+1;} ?>" size="20" required>
                                    </td>
                                    <?php
                                        }else{
                                    ?>        
                                           <td><input type="text" name="pid" value="<?php echo 1; ?>" size="20" required>
                                    </td>
                                    <?php 
                                        }
                                    ?>
                                ...
                                <tr>
                                    <td><input type="submit" name="submit1" value="Submit Form"></td>
                                </tr>
                                </table>
                                </form>
                                <?php
                     ...
                     if(isset($_POST["submit1"])){
                        ...
                        $sname=$_POST['sname'];
                        $s_housename=$_POST['s_housename'];
                        $s_streetname=$_POST['s_streetname'];
                        $s_city=$_POST['s_city'];
                        ...
                        $qry2=mysqli_query($con,"INSERT INTO `sms_parents`(`p_name`, `phone`, `email`, `p_housename`, `p_streetname`, `p_city`, `p_pincode`) VALUES ('".$name."','".$phone."','".$email."','".$house."','".$street."','".$city."','".$pincode."')");
                        $qry3=mysqli_query($con,"INSERT INTO `sms_students`(`s_fullname`, `s_housename`, `s_streetname`, `s_city`, `s_pincode`, `s_email`, `s_dob`, `s_gender`, `s_class`, `s_sec`, `s_doj`, `parent_id`) VALUES ('".$sname."','".$s_housename."','".$s_streetname."','".$s_city."','".$s_pincode."','".$s_email."','".$s_dob."','".$s_gender."','".$class."','".$sec."','".$doj."','".$pid."')");
                        $fee=mysqli_query($con,"UPDATE `sms_fees` SET `pid`='".$pid."' WHERE `id`='".$feeid."'");
                        if($qry2 && $qry3 && $fee){

                          $to=$_POST['email'];
                          $sub="Admission";
                          $msg="Hai ".$name.", 
                                Your Admission Request to the School Management System has been Approved. Now you and your child can login to the system from corresponding login sections.";
                          $from="From: schoolsms110@gmail.com";

                          mail($to, $sub, $msg, $from);
                        ?>
                          <script type="text/javascript">
                            alert("Parent and Student Data inserted Succssfully.")
                          </script>
                        <?php
                        }else{
                           ?>
