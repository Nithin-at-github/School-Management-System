                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div>
                        ...
                        <?php
                         if(isset($_POST['view'])){
                            $class=$_POST['class'];
                            $qry=mysqli_query($con,"select * from sms_students where s_class='".$class."'");
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered first">
                                            ...
                                            <tr>
                                                    ...
                                                    <td>
                                                        <?php
                                                        $fee=mysqli_query($con,"select * from sms_fees where pid='".$r['parent_id']."' and remark='Term 1'");
                                                    ...
                                                    <td>
                                                        <?php
                                                        $fee=mysqli_query($con,"select * from sms_fees where pid='".$r['parent_id']."' and remark='Term 2'");
                                                        if(mysqli_num_rows($fee)>0){
                                                            echo "Paid";
                                                        }else{
                                                            echo "Due (not paid)";
                                                    ...
                                                    <td>
                                                        <?php
                                                        $fee=mysqli_query($con,"select * from sms_fees where pid='".$r['parent_id']."' and remark='Term 3'");
                                                        if(mysqli_num_rows($fee)>0){
                                                            echo "Paid";
                                                        }else{
                                                            echo "Due (not paid)";
