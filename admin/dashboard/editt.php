<?php
 ...
 if(isset($_SESSION['id'])){
  ...
  if(isset($_POST['edit'])){
    ...
    $alt=mysqli_query($con,"UPDATE `sms_teachers` SET `t_fullname`='".$name."',`t_housename`='".$housename."',`t_streetname`='".$streetname."',`t_city`='".$city."',`t_pincode`='".$pincode."',`t_email`='".$email."',`t_dob`='".$dob."',`t_gender`='".$gender."',`t_bloodgroup`='".$bloodgrp."',`t_contact`='".$phoneno."',`t_qualification`='".$qualificaion."',`salary`='".$salary."',`acc_no`='".$accno."',`ifsc`='".$ifsc."' WHERE `tid`='".$_GET['tid']."'");
    if($alt){
        ?>
            <script>
        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Edit Teachers</h2>
                    ...
                    <?php
                    $tid=$_GET['tid'];
                    $cod=mysqli_query($con,"select * from sms_teachers where tid='".$tid."'");
                    ...
                    ?>
                        ...
                        <table cellpadding="16" width="60%" cellspacing="10">
                            <tr>
                               <td colspan=6>
                                    <center><font size=4><b>Teacher Details</b></font></center>
                               </td>
                            </tr>
                            <tr>
                                <td>Full Name</td>
                                <td><input type=text name=fullname value="<?php echo $r["t_fullname"]; ?>" size="45" required></td>
                            
                                <td>House Name</td>
                                <td><input type="text" name="housename" value="<?php echo $r["t_housename"]; ?>" size="45" required></td>
                            </tr>
                            <tr>
                                <td>Street Name</td>
                                <td><input type="text" name="streetname" value="<?php echo $r["t_streetname"]; ?>" size="45" required></td>
                            
                                <td>City</td>
                                <td><input type="text" name="city" value="<?php echo $r["t_city"]; ?>" size="45" required></td>
                            </tr>
                            <tr>
                                <td>Pincode</td>
                                <td><input type="text" name="pincode" value="<?php echo $r["t_pincode"]; ?>" size="45" required></td>

                                <td>Email Id</td>
                                <td><input type="email" name="emailid" value="<?php echo $r["t_email"]; ?>" size="45" required></td>
                            </tr>
                            <tr>
                                <td>D.O.B</td>
                                <td><input type="date" name="dob" value="<?php echo $r["t_dob"]; ?>" size="45" required></td>
                            
                                <td>Gender</td>
                                <td><input type="text" name="gender" value="<?php echo $r["t_gender"]; ?>" size="45" required>
                                </td>
                            </tr>
                            <tr>    
                                <td>Blood Group</td>
                                <td><input type="text" name="bloodgrp" value="<?php echo $r["t_bloodgroup"]; ?>" size="45" required></td>

                                <td>Contact No.</td>
                                <td><input type="text" name="contactno" value="<?php echo $r["t_contact"]; ?>" size="45" required=""></td>
                            </tr>
                            <tr>
                                <td>Qualification</td>
                                <td><input type="text" name="qualificaion" value="<?php echo $r["t_qualification"]; ?>" size="45" required></td>

                                <td>Account Number</td>
                                <td><input type="text" name="accno" value="<?php echo $r["acc_no"]; ?>" size="45" required></td>
                            </tr>
                            <tr>
                                <td>IFSC Code</td>
                                <td><input type="text" name="ifsc" value="<?php echo $r["ifsc"]; ?>" size="45" required></td>

                                <td>Salary</td>
                                <td><input type="text" name="salary" value="<?php echo $r["salary"]; ?>" size="45" required></td>
                            </tr>
                            <tr>
