<?php
 ...
 if(isset($_SESSION['id'])){
  ...
  if(isset($_POST['edit'])){
    ...
    $alt=mysqli_query($con,"UPDATE `sms_students` SET `s_fullname`='".$sname."',`s_housename`='".$housename."',`s_streetname`='".$streetname."',`s_city`='".$city."',`s_pincode`='".$pincode."',`s_email`='".$email."',`s_dob`='".$dob."',`s_gender`='".$gender."',`s_class`='".$class."',`s_sec`='".$sec."',`parent_id`='".$pid."' WHERE `id`='".$_GET['sid']."'");
    if($alt){
        ?>
            <script>
        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Edit Students</h2>
                    ...
                    <?php
                    $sid=$_GET['sid'];
                    $cod=mysqli_query($con,"select * from sms_students where sid='".$sid."'");
                    ...
                    ?>
                        <form action="#" method="post">
                                <table cellpadding="16" width="60%" cellspacing="10">
                                    ...
                                    <td colspan=6>
                                        <center><font size=4><b>Student Details</b></font></center>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Full Name</td>
                                    <td><input type=text name="sname" value="<?php echo $r["s_fullname"]; ?>" size="45" required=></td>
                            
                                    <td>House Name</td>
                                    <td><input type="text" name="housename" value="<?php echo $r["s_housename"]; ?>" size="45" required></td>
                                </tr>
                                <tr>
                                    <td>Street Name</td>
                                    <td><input type="text" name="streetname" value="<?php echo $r["s_streetname"]; ?>" size="45" required></td>
                            
                                    <td>City</td>
                                    <td><input type="text" name="city" value="<?php echo $r["s_city"]; ?>" size="45" required></td>
                                </tr>
                                <tr>
                                    <td>Pincode</td>
                                    <td><input type="text" name="pincode" value="<?php echo $r["s_pincode"]; ?>" size="45" required></td>

                                    <td>Email</td>
                                    <td><input type="email" name="email" value="<?php echo $r["s_email"]; ?>" size="45" required></td>
                                </tr>
                                <tr>
                                    <td>D.O.B</td>
                                    <td><input type="date" name="dob" value="<?php echo $r["s_dob"]; ?>" size="45" required></td>

                                    <td>Gender</td>
                                    <td><input type=text name="gender" value="<?php echo $r["s_gender"]; ?>" size="20" required=></td>
                                </tr>
                                <tr>
                                    <td>Class</td>
                                    <td><input type="text" name="class" value="<?php echo $r["s_class"]; ?>" size="20" required></td>
                                    
                                    <td>Section</td>
                                    <td><input type="text" name="sec" value="<?php echo $r["s_sec"]; ?>" size="20" required></td>
                                </tr>
                                <tr>
                                    
                                    <td>Parent Id</td>
                                    
                                    <td><input type="text" name="pid" value="<?php echo $r["parent_id"]?>" size="20" required></td>
                                </tr>
                                <tr>
                                    <td><input type="submit" name="reset" value="Submit Form"></td>
                                </tr>
                                </table>
                                </form>
                                <?php
