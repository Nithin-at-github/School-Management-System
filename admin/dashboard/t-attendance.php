<?php
 ...
 if(isset($_SESSION['id'])){
  ...
  if(isset($_POST['submit_n'])){
    $qry1="UPDATE `sms_notification` SET `active`='0' WHERE `active`='1'";
                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <?php
                      if(isset($_POST['submit'])){
                        $date=$_POST['date'];
                        $qry=mysqli_query($con," select * from sms_teacher_att where date='".$date."' ");
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Teacher Attendance</h5>
                            <div class="card-body">
