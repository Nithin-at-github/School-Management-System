 ...
 if(isset($_SESSION['id'])){
  ...
  for($i=1;$i<=$c;$i++){
    if(isset($_POST['delete'.$i])){
        $id=$_POST['id'.$i];
        $del=mysqli_query($con,"DELETE FROM `sms_parents` WHERE `pid`='".$id."'");
        if($del){
            ?>
            <script>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">All Parents</h2>
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="index.html" class="breadcrumb-link">Parents</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">All Parents</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><a href="editp.php?pid=<?php echo $rows['pid'];?>"><i class="fas fa-pencil-alt">&nbsp;Edit</i></a><br>
                                                    <form method="post" action="#"><button type="submit" name="delete<?php echo $i ?>"><i class="fas fa-times">&nbsp;Delete</i></button>
                                                        <input type="hidden" name="id<?php echo $i ?>" value="<?php echo $rows['pid'];?>">
                                                    </form></td>
                                                <td><?php echo $rows['pid'];?></td>
                                                <td><?php echo $rows['p_name'];?></td> 
                                                <td><?php echo $rows['phone'];?></td> 
                                                <td><?php echo $rows['email'];?></td>
                                                <td><?php echo $rows['p_housename'];?></td> 
                                                <td><?php echo $rows['p_streetname'];?></td>
                                                <td><?php echo $rows['p_city'];?></td>
                                                <td><?php echo $rows['p_pincode'];?></td>
                                            </tr>
                                        </tbody>
                                        <?php 
                                                $i++;
