 ...
 if(isset($_SESSION['id'])){
  ...
  for($i=1;$i<=$c;$i++){
    if(isset($_POST['delete'.$i])){
        $id=$_POST['id'.$i];
        $del=mysqli_query($con,"DELETE FROM `sms_teachers` WHERE `tid`='".$id."'");
        if($del){
            ?>
            <script>
                alert("Id no <?php echo $id; ?> deleted Successfully.");
            </script>
            <?php
        }else{
            ?>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">All Teachers</h2>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><a href="editt.php?tid=<?php echo $rows['tid'];?>"><i class="fas fa-pencil-alt">&nbsp;Edit</i></a><br>
                                                    <form method="post" action="#"><button type="submit" name="delete<?php echo $i ?>"><i class="fas fa-times">&nbsp;Delete</i></button>
                                                        <input type="hidden" name="id<?php echo $i ?>" value="<?php echo $rows['tid'];?>">
                                                    </form></td>
                                                <td><?php echo $rows['tid'];?></td> 
                                                <td><?php echo $rows['t_fullname'];?></td> 
                                                <td><?php echo $rows['t_housename'];?></td> 
                                                <td><?php echo $rows['t_streetname'];?></td>
                                                <td><?php echo $rows['t_city'];?></td>
                                                <td><?php echo $rows['t_pincode'];?></td> 
                                                <td><?php echo $rows['t_email'];?></td>
                                                <td><?php echo $rows['t_dob'];?></td> 
                                                <td><?php echo $rows['t_gender'];?></td>
                                                <td><?php echo $rows['t_bloodgroup'];?></td> 
                                                <td><?php echo $rows['t_contact'];?></td>
                                                <td><?php echo $rows['t_qualification'];?></td>
                                            </tr>
                                        </tbody>
                                        <?php 
                                                 $i++;
