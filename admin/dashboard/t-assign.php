<?php
 ...
 if(isset($_SESSION['id'])){
  ...
  $sql = "SELECT * FROM sms_teachers ORDER BY t_fullname"; 
  ...
  if(isset($_POST['make'])){
    ...
    $cod=mysqli_query($con,"UPDATE `sms_teachers` SET `i-class`='".$class."',`i-sec`='".$sec."' WHERE `tid`='".$id."'");
    if($cod){
        ?>
            <script>
              alert("Class Incharge updated Successfully.");
            </script>
        <?php
    }else{
        ?>
            ...
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Assign Class</h2>
                    ...
                    <form method="post" action="#">
                        ...
                        <select name="incharge" required>
                            <option value="" selected>Select Teacher</option>
                                <?php
                                  while ($fet=mysqli_fetch_array($result)) {
                                ?>
                                <option value="<?php echo $fet['tid']; ?>"><?php echo $fet['t_fullname']; ?></option>
                                <?php
                                  }
                                ?>
                        </select>&emsp;&emsp;&emsp;
                        <button type="submit" name="make">Submit</button>
                    </form>
                    <br><br>
                    <form method="post" action="#">
                        <button type="submit" name="showall">View All Incharges</button>
                    </form><br>
                    </div>
                    <div class="row">
                    <!-- ============================================================== -->
                    ...
                    <!-- ============================================================== -->
                        <?php
                            if(isset($_POST["showall"])){
                                $show=mysqli_query($con,"select * from sms_teachers order by t_fullname");
                                $count=$show->num_rows;
                                if($count>0){
                        ?> 
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="card">
                                            <h5 class="card-header">Class Incharges</h5>
                                            <div class="card-body">
                                                    ...
                                                    <table class="table table-striped table-bordered first">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td><?php echo $rows['i-class'];?>&emsp;<?php echo $rows['i-sec']; ?></td>
                                                            </tr>
                                                        </tbody>
                                                        <?php 
                                                        } 
