                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <?php
                      if(isset($_POST['view'])){
                        ...
                        $class=$_POST['class'];
                        $sec=$_POST['sec'];
                        $qry=mysqli_query($con,"select * from sms_students where s_class='".$class."' and s_sec='".$sec."' order by s_fullname");
                                    ...
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <?php
                                                for ($i=1; $i <=8 ; $i++) {
                                                    $cod=mysqli_query($con,"select status from sms_student_att where date='".$date."' and class='".$class."' and sec='".$sec."' and sid='".$rows['sid']."' and session='".$i."'");
                                                    if($cod){
                                                       $f=mysqli_fetch_assoc($cod);
                                                       ?>
