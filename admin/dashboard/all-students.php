 ...
 if(isset($_SESSION['id'])){
  ...
  for($i=1;$i<=10;$i++){
    if(isset($_POST['delete'.$i])){
        $id=$_POST['id'.$i];
        $del=mysqli_query($con,"DELETE FROM `sms_students` WHERE `sid`='".$id."'");
        if($del){
            ?>
            <script>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><a href="edits.php?sid=<?php echo $rows['sid'];?>"><i class="fas fa-pencil-alt">&nbsp;Edit</i></a><br>
                                                    <form method="post" action="#"><button type="submit" name="delete<?php echo $i ?>"><i class="fas fa-times">&nbsp;Delete</i></button>
                                                        <input type="hidden" name="id<?php echo $i ?>" value="<?php echo $rows['sid'];?>">
                                                    </form></td>
                                                <td><?php echo $rows['sid'];?></td> 
                                                <td><?php echo $rows['s_fullname'];?></td> 
                                                <td><?php echo $rows['s_housename'];?></td> 
                                                <td><?php echo $rows['s_streetname'];?></td>
                                                <td><?php echo $rows['s_city'];?></td>
                                                <td><?php echo $rows['s_pincode'];?></td>  
                                                <td><?php echo $rows['s_email'];?></td>
                                                <td><?php echo $rows['s_dob'];?></td> 
                                                <td><?php echo $rows['s_gender'];?></td>
                                                <td><?php echo $rows['s_class'];?></td> 
                                                <td><?php echo $rows['s_sec'];?></td>
                                                <td><?php echo $rows['s_doj'];?></td>
