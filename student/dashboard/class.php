                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#"><i class="fas fa-users"></i>Attend Class</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Attend Class</h2>
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="index.html" class="breadcrumb-link">Dashboard</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Attend Class</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane fade active show" id="inbox" aria-labelledby="inbox-tab" role="tabpanel">
                        <div>
                            <div class="row p-4 no-gutters align-items-center">
                                <?php
                                  $det=mysqli_query($con,"select * from sms_students where s_fullname='".$_SESSION['name']."'");
                                  $f=mysqli_fetch_assoc($det);
                                  $act=mysqli_query($con,"select * from sms_class where class='".$f['s_class']."' and sec='".$f['s_sec']."' order by id desc");
                                ?>
                                <div class="col-sm-12 col-md-6">
                                    <h3 class="font-light mb-0">Class Links Available</h3>
                                </div>
                            </div>
                            <!-- Mail list-->
                            <?php
                                    ...
                                    ?>
                                        ...
                                        <table class="table email-table no-wrap table-hover v-middle mb-0 font-14">
                                            <tbody>
                                                ...
                                                <?php
                                                    $i="1";
                                                    while ($s=mysqli_fetch_assoc($act)) {
                                                        $nam=mysqli_query($con,"select t_fullname from sms_teachers where tid='".$s['tid']."'");
                                                        $fe=mysqli_fetch_assoc($nam);
                                                ?>
                                                        <tr>
                                                            <td>
                                                            <span class="mb-0 text-muted"><?php echo $fe['t_fullname']; ?></span>
                                                            </td>
                                                            <!-- Message -->
                                                            <td>
                                                                ...
                                                                <div id="<?php echo $i; ?>" class="collapse submenu">
                                                                    <a href="<?php echo $s['link']; ?>" target="_blank" rel="noopener noreferrer"><?php echo $s['link']; ?>
                                                                    </a>
                                                                </div>
                                                            </td>
                                                            <!-- Time -->
